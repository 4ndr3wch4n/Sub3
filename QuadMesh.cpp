...
void QuadMesh::createBlob()
{
	...
	blob[blobCounter].height = 3;
	blob[blobCounter].width = 1;
	blob[blobCounter].x = -5;
	blob[blobCounter].z = -5;
	blobCounter++; //make next blob
	blob[blobCounter].height = 3;
	blob[blobCounter].width = 1;
	blob[blobCounter].x = 6;
	blob[blobCounter].z = 6;
	blobCounter++; //make next blob
	blob[blobCounter].height = 2;
	blob[blobCounter].width = 1;
	blob[blobCounter].x = -2;
	blob[blobCounter].z = -4;
	blobCounter++; //make next blob
	blob[blobCounter].height = 2;
	blob[blobCounter].width = 1;
	blob[blobCounter].x = -4;
	blob[blobCounter].z = -1;
	blobCounter++; //make next blob
	blob[blobCounter].height = 1;
	blob[blobCounter].width = 1;
	blob[blobCounter].x = 2;
	blob[blobCounter].z = 2;
	blobCounter++; //make next blob
	blob[blobCounter].height = 1;
	blob[blobCounter].width = 1;
	blob[blobCounter].x = 2;
